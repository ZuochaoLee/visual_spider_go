...
func (this *Page) AddMyTargetRequests(urls []string, respType, urltag, resqType, postdata, proxy, heardefile, cookie string) *Page {
	for _, url := range urls {
		this.AddMyTargetRequest(url, respType, urltag, resqType, postdata, proxy, heardefile, cookie)
	}
	return this
}
